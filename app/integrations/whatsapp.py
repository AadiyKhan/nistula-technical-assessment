...
class WhatsAppAdapter:
    ...
    def normalize(self, payload: dict[str, Any]) -> ChannelMessage:
        guest_name = str(payload.get("guest_name") or payload.get("name") or payload.get("from_name") or "Guest")
        ...
        return ChannelMessage(
            ...
            message=message,
            timestamp=timestamp,
            booking_ref=_optional_str(payload.get("booking_ref") or payload.get("bookingCode")),
